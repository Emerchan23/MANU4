...
const dbConfig = {
  ...
  charset: 'utf8mb4',
  timezone: '+00:00',
  // Pool de conexões otimizado - configurado para 30 usuários simultâneos
  connectionLimit: 200, // Otimizado para 30 usuários (4 conexões cada + margem de segurança)
  acquireTimeout: 30000, // 30 segundos - mais tempo para aguardar conexão
  timeout: 60000, // 60 segundos timeout - mais tempo para queries complexas
  ...
  // Configurações de timeout e idle otimizadas
  idleTimeout: 60000, // 60 segundos para conexões idle
  maxIdle: 2, // Máximo 2 conexões idle
