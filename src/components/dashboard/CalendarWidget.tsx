...
const statusColors = {
  ...
  agendado: 'text-blue-600 bg-blue-100',
          ...
          {events.map((event) => (
            <div
              ...
              className={`border-l-4 pl-4 py-3 rounded-r-lg ${
                priorityColors[event.priority as keyof typeof priorityColors] || 'border-l-gray-300 bg-gray-50'
              }`}
            >
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${
                      statusColors[event.status as keyof typeof statusColors] || 'text-gray-600 bg-gray-100'
                    }`}>
